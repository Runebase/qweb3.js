...
describe('Encoder', () => {
  ...
  describe('addressToHex()', () => {
    it('should convert a runebase address', () => {
      assert.equal(
  ...
  describe('constructDataHex()', () => {
    ...
    it('converts fixed array address types', () => {
      ...
      const args = [['5j6VCc8Niq88wVBNW3yQj17sR89SGKHsKF', '5Ru6a9eut9GiSpHdxeuYUva9pBogN6gooo']];
      const dataHex = Encoder.constructData([methodObj], 'testMethod', args);

      const funcHash = Encoder.objToHash(methodObj, true);
      const param1 = '000000000000000000000000be9c15b6bebdcbba5bc01569204bc8528e292d18';
      const param2 = '00000000000000000000000001fa7b46957265e96b68f09dba6cf1f1b3527e16';
