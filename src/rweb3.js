...
class Rweb3 {
  ...
  */
   ...
   * @param address {String} Runebase address
   ...
   * @param hexAddress {String} Runebase address in hex format.
   ...
   * @param address {String} Runebase address to validate.
  ...
  * @param address {String} The runebase address for the private key.
  ...
  * @param address {String} The runebase address for account lookup.
  ...
  */
  ...
  /*
  * Lists unspent transaction outputs.
  * @param address {String} Address to send RUNEBASE to.
  * @param amount {Number} Amount of RUNEBASE to send.
  ...
  * @param senderAddress {String} The RUNEBASE address that will be used to send money from.
  ...
  * @param amount {Number} The transaction fee in RUNEBASE/kB.
