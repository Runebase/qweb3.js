...
const { getRunebaseRPCAddress } = require('./config/config');
...
describe('Contract', () => {
  ...
  describe('constructor', () => {
    ...
    it('removes the hex prefix from the address', async () => {
      contract = new Contract(getRunebaseRPCAddress(), '0x1234567890', ContractMetadata.EventFactory.abi);
  ...
  describe('constructDataHex()', () => {
    beforeEach(() => {
      contract = new Contract(
        getRunebaseRPCAddress(), ContractMetadata.EventFactory.address,
        ContractMetadata.EventFactory.abi,
      );
    });
